...
public class LinkifyTest {
    ...
    public void testNoLinks() {
        assertEquals("Hello world", Linkify.linkify("Hello world"));
    }

    @Test
    public void testMixture() {
        assertEquals("Any links to <a href='http://github.com' target='_blank'>github.com</a> here? If not, contact test@example.com",
                Linkify.linkify("Any links to github.com here? If not, contact test@example.com"));
    }

    @Test
    public void testNothingButLink() {
        assertEquals("<a href='http://example.com' target='_blank'>example.com</a>", Linkify.linkify("example.com"));
    }
    ...
    public void testWithPath() {
        assertEquals("<a href='https://featureupvote.com/blog/sort-suggestions-by-trending/' target='_blank'>https://featureupvote.com/blog/sort-suggestions-by-trending/</a>",
                Linkify.linkify("https://featureupvote.com/blog/sort-suggestions-by-trending/"));
    }
    ...
    public void testWithHttpSchema() {
        assertEquals(
                ...
                Linkify.linkify("Hello world at http://example.com/"));
    }
    ...
    public void testWithHttpsSchema() {
        assertEquals(
                ...
                Linkify.linkify("Hello world at https://example.com/"));
    }
    ...
    public void testEmailAddress() {
        ...
        assertEquals(
                ...
                Linkify.linkify("Contact test@example.com"));
    }
    ...
    public void testWithPathQueryParams() {
        assertEquals("<a href='https://featureupvote.com/blog/sort-suggestions-by-trending/?test=123&hello' target='_blank'>https://featureupvote.com/blog/sort-suggestions-by-trending/?test=123&hello</a>",
                Linkify.linkify("https://featureupvote.com/blog/sort-suggestions-by-trending/?test=123&hello"));
    }
    ...
    public void testWithSubdomain() {
        assertEquals(
                ...
                Linkify.linkify("Hello world at http://www.example.com"));
    }
    ...
    public void testWithSubdomainTldNet() {
        assertEquals(
                ...
                Linkify.linkify("Hello world at http://www.example.net"));
    }
    ...
    public void testWithSubdomainTldAcademy() {
        assertEquals(
                ...
                Linkify.linkify("Hello world at http://www.example.academy"));
    }
    ...
    public void testWithSubdomainTldCoUk() {
        assertEquals(
                ...
                Linkify.linkify("Hello world at http://www.example.co.uk"));
    }
    ...
    public void testWithSubdomainAndPathQueryParams() {
        assertEquals(
                ...
                Linkify.linkify("Hello world at http://www.example.com?test=123&hello"));
    }
    ...
    public void testWithNestedSubdomain() {
        assertEquals(
                ...
                Linkify.linkify("Hello world at https://test.test2.featureupvote.com"));
    }
    ...
    public void testWithNestedSubdomainAndQueryParams() {
        assertEquals(
                ...
                Linkify.linkify("Hello world at http://www.test1.example.com?test=123&amp;hello"));
    }
    ...
    public void testWithNestedSubdomainAndPath() {
        assertEquals(
                ...
                Linkify.linkify("Hello world at https://test.test2.featureupvote.com/suggestions/1234test/testing1-test"));
    }
    ...
    public void testWithNestedSubdomainAndPathQueryParams() {
        assertEquals(
                ...
                Linkify.linkify("Hello world at https://test.test2.featureupvote.com/suggestions/1234test/testing1-test?test=123&amp;hello"));
    }
    ...
    public void testWithNestedSubdomainTldCoUkAndPathQueryParams() {
        assertEquals(
                ...
                Linkify.linkify("Hello world at https://test.test2.featureupvote.co.uk/suggestions/1234test/testing1-test?test=123&amp;hello"));
    }

    @Test
    public void testNothingButSubdomainLink() {
        assertEquals("<a href='http://test.example.com' target='_blank'>test.example.com</a>", Linkify.linkify("test.example.com"));
    }

    @Test
    public void testNothingButNestedSubdomainLink() {
        assertEquals("<a href='http://test1.test.example.com' target='_blank'>test1.test.example.com</a>", Linkify.linkify("test1.test.example.com"));
    }
    ...
    public void testWithNestedSubdomainWithQueryDollarSignParam() {
        assertEquals(
                ...
                Linkify.linkify("Hello world at http://www.test1.example.com?test=123&amp;h$ello"));
    }
    ...
    public void testWithNestedSubdomainWithQueryExclamationMarkSignParam() {
        assertEquals(
                ...
                Linkify.linkify("Hello world at http://www.test1.example.com?test=123&amp;hello=!test"));
    }
    ...
    public void testWithNestedSubdomainWithQuerymixedCharacterParams() {
        assertEquals(
                ...
                Linkify.linkify("Hello world at http://www.test1.example.com?test=123$&amp;h*e)ll(o=!test test"));
    }
